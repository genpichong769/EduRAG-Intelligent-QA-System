...
if __name__ == "__main__":
    # 初始化分类器
    classifier = QueryClassifier(model_path=os.getenv("BERT_BASE_MODEL", "bert-base-chinese"))

    # 训练模型
    classifier.train_model(
        data_file=os.path.join(os.path.dirname(__file__), "..", "classify_data", "chatgpt_generate_200.jsonl")
    )
    # 示例预测
    test_queries = [
        "AI学科的课程大纲是什么",
