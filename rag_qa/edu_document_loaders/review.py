...
from rag_qa.edu_document_loaders.edu_ocr import *
import numpy as np
...
if __name__ == '__main__':
    sample_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "samples", "ocr_01.pptx")
    ppt2text(filepath=sample_path)
